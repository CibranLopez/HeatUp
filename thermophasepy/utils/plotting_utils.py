"""thermophasepy.utils.plotting_utils
=====================================
Publication-quality figure generators for ThermoPhase.
...
fig6_benchmark_matrix     — Confusion matrix: ThermoPhase verdict vs experiment
"""
...
def fig1_pipeline_schematic(save_path: str | None = None) -> plt.Figure:
    ...
    ax.set_title(
        "ThermoPhase sequential stability pipeline",
...
# =============================================================================
# Fig 6 — Benchmark: ThermoPhase verdict vs experimental synthesisability
# =============================================================================

def fig6_benchmark_matrix(save_path: str | None = None) -> plt.Figure:
    """Confusion matrix and ROC-like curve comparing ThermoPhase stability
    ...
    """
    # Synthetic confusion matrix (ThermoPhase vs experiment)
    # Rows = experimental outcome (synthesised / not)
    # Cols = ThermoPhase verdict (stable / unstable)
    CM = np.array([
    ...
    ax1.set_xlabel("ThermoPhase verdict")
